...
class LogHookConfig {
     ...
     * 日志采集埋点入口类
     */
    public static final String LOG_ANALYTICS_BASE = "com/codeless/tracker/AutoTrackHelper"
    ...
    static void addInterfaceMethods() {
    ...
    static void addFragmentMethods() {
